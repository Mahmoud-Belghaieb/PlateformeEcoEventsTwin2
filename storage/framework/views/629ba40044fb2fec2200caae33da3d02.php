...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'EcoEvents'); ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav me-auto">
                    ...
                    <a class="nav-link" href="<?php echo e(route('sponsors.index')); ?>">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('produits.index')); ?>">
                                    <i class="fas fa-shopping-bag me-2 text-primary"></i>Produits Écologiques
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('materiels.index')); ?>">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('panier.index')); ?>">
                                        ...
                                        ?>
                                        <?php if($cartCount > 0): ?>
                                            <span class="badge bg-danger ms-1"><?php echo e($cartCount); ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('panier.orders')); ?>">
                    ...
                    <a class="nav-link" href="<?php echo e(route('avis.index.all')); ?>">
                ...
                <div class="navbar-nav ms-auto">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a class="nav-link position-relative" href="<?php echo e(route('panier.index')); ?>" title="Mon Panier">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('my-events')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('panier.index')); ?>">
                                        ...
                                        <?php if($userCartCount > 0): ?>
                                            <span class="badge bg-danger ms-1"><?php echo e($userCartCount); ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
                                <li>
...
</html><?php /**PATH C:\Users\mahmo\OneDrive\Documents\5TWIN\Applications web avancées\PlateformeEcoEventsTwin2\resources\views/layouts/app.blade.php ENDPATH**/ ?>